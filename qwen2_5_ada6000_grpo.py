#!/usr/bin/env python3
# Qwen2.5 (3B) GRPO Training Script for Ada 6000 GPUs
# Optimized for Ada 6000 with 48GB VRAM, 64GB system RAM
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train Qwen2.5 with GRPO on Ada 6000 GPU")
    ...
    parser.add_argument("--learning_rate", type=float, default=5e-6,
                        help="Learning rate")
    # IMPORTANT: Fixed settings to ensure batch compatibility with generations
